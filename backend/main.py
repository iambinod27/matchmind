...
Give 3 puchy sentences, pundit style."""
...
Predict the outcome. Give:
1. Predicted Scorline
2. Confidence (low/medium/high)
3. Two sentences of pundit-style reasing based on the form shown."""
...
async def get_competitions():
    ...
    # Return just what we need, filtered to leagues we care about
    return [
